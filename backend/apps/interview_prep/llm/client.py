"""Provider-neutral construction of configured LangChain chat models for interview_prep app."""
...
from apps.interview_prep.constants import LLM_MAX_RETRIES
from apps.interview_prep.exceptions import LLMConfigurationException
...
class LLMProvider:
    ...
    def _groq() -> ChatGroq:
        ...
        logger.info("Configured LLM provider for interview prep | provider=groq | model=%s", model)
        return ChatGroq(
            api_key=api_key,
            model=model,
