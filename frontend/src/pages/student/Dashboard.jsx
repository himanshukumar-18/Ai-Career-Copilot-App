...
const Dashboard = () => {
    ...
    const quickActions = [
        ...
        },
        {
            ...
            description: "Create an ATS-friendly, professional resume with live PDF export.",
            link: "/resume",
        },
        {
            title: "Career Roadmap",
            description: "Step-by-step personalized learning paths generated by AI mentor.",
            link: "/roadmap",
        },
        {
            title: "Project Lab",
            description: "Build portfolio-ready projects aligned with your target stack.",
            link: "/project-lab",
        },
        {
            title: "Interview Prep",
            description: "AI-powered gap diagnostics, answer evaluations, & mock interviews.",
            link: "/interview-prep",
        },
        {
            title: "AI Resume Analysis",
            description: "Get ATS scores, section feedback, and instant AI improvements.",
            link: "/resume",
        },
    ];
